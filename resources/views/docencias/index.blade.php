    ...
    <div class="col">
                    ...
                    @foreach($disciplinas as $disciplina)
                        <tr>
                            ...
                            <td scope="col" class="text-center">
                                <select name="professore_id" class="form-select @if($errors->has('professore_id')) is-invalid @endif" class="form-control ">
                                ...
                                @if($errors->has('professore_id'))
                                    <div class='invalid-feedback'>
                                        {{ $errors->first('professore_id') }}
                                    </div>
                                @endif
                            </td>
                        </tr>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12">
                <a href="{{route('disciplinas.index')}}" class="btn btn-danger btn-block align-content-center w-100">
